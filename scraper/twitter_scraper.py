...
class Twitter_Scraper:
    ...
    def login(self):
        ...
        try:
            ...
            auth_token = "f26cc155165053ba570e452ec2ff0d4eb5a44901"
...
"""
    ...
    def _input_username(self):
        ...
        while True:
            try:
                username = WebDriverWait(self.driver, 10,1).until(
...
- Twitter is experiencing unusual activity"""
    ...
    def scrape_tweets(
        ...
        while self.scroller.scrolling:
            # try:
            #     letgo=self.driver.find_element('xpath', '//a[@href="/i/connect_people"]')
            #     letgo.click()
            # except:
            #     pass
            sleep(2)
    ...
    def save_to_csv(self):
        ...
        file_path = f"{folder_path}{current_time}_tweets_1-{len(self.data)}_1.csv"
